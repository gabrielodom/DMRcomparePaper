...
#'    apply the \code{dmrcate} method to them (with parameters also within the
#'    design). Write the results to a file.
#'
...
#'    data set.
#' @param Aclusters_df A data frame of \code{Aclust} results. This is given in
