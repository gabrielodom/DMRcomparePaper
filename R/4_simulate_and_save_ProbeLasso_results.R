...
#'
#' @description Given a set of design points (treatment effect size to be added and number of repetitions),
#' simulate simulate methylation data with DMRs and apply the ProbeLasso method (via the \code{\link[ChAMP]{champ.DMR}}
...
#'    given in the \code{startEndCPG_df} data set.This file can be generated by the file \code{/inst/1_Aclust_data_import.R}
#'    
