...
#'    
#' @param numClusters_int The total number of randomly selected clusters, for which treatment effect \code{delta_num}
#'  is then added 
#'
...
#'        only for clusters identified by \code{Aclust} and indicator variable for whether treatment effects
