...
Main output: 
  - These functions compares the significant DMRs identified by each method, evaluates whether they overlap with the true positive clusters where treatment effects were added, and then computes summary statistics including TP, FP, TN, FN, power, precision, median number of CpGs in significant DMRs
