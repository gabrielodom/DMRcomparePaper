...
Output: beta value matrix for selected methylation datasets (rows = cpg ids, column = sample numbers)


### II. Perform Adjacent Site Clustering to Obtain Clusters of Adjacent CpG Probes (A-clusters)

The A-clustering algorithm described in Sofer et al. (2011) was used identifying clusters of adjacent CpGs. 

File: `/inst/1_Aclust_data_import.R`

Input: beta value matrix, annotation file that indicates locations of CpGs

Output: startEndCPG_df (file indicating clusters of CpGs, an example file is at )
