...
a) Simulate differentially methylated clusters of CpGs. 
    ...
    - Main Input: `betaVals_mat`(beta values for all probes on the array), `startEndCpG_df` (file that indicates clusters of CpGs), treatment effects to be added to the clusters (e.g. delta = c(0.025, 0.05, 0.1, 0.15, 0.2, 0.3, 0.4) in our study)
